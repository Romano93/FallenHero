...
namespace FallenHero.Other
{
    public static class Offsets
    {
        // DONT OVERRIDE WHILE UPDATE!!!
        public const Int32 m_vecMins = 0x320;
        public const Int32 m_vecMaxs = 0x32C;
        public const Int32 iDormant = 0xE9;
        // DONT OVERRIDE WHILE UPDATE!!!
